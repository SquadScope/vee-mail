...
echo "From: $SENDERNAME  $ltlt$EMAILFROM$gtgt" >> $EMAILFILE
echo "To: $SENDERNAME  $ltlt$EMAILTO$gtgt" >> $EMAILFILE
echo "Mime-Version: 1.0" >> $EMAILFILE
echo "Content-Type: text/html" >> $EMAILFILE
#echo "Cc: $friendname $ltlt$EMAILCCTO$gtgt" >> $EMAILFILE
echo "" >> $EMAILFILE
